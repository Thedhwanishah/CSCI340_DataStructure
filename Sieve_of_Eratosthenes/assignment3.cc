/***********************************************************************
CSCI 340 - Assignment 3 - Spring 2016

Programmer: Dhwani Shah
Z-ID: z1787631 Purpose:  This program is used to find the prime numbers from a given
		  range of input using "Sieve of Eratosthenes".
************************************************************************/
