/*********************************************************************
CSCI 340 - Assignment 6 - Spring 2016

Programmer: Dhwani Shah
Z-ID: z1787631
Section: 3
TA: Robert Durham
Date Due: March 23,2016

Purpose: This program is to implement BST. To implement insert(),
         search(), remove() and return the sum of all the left
         leaf nodes.
*********************************************************************/
